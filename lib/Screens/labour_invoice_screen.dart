...
import 'package:marketapp/API/labour_pdf_invoice_api.dart';
...
class Lobourinvoicescreen extends StatefulWidget {
  const Lobourinvoicescreen({Key? key}) : super(key: key);

  @override
  State<Lobourinvoicescreen> createState() => _LobourinvoicescreenState();
}

class _LobourinvoicescreenState extends State<Lobourinvoicescreen> {
  ...
  void pdffunct() async {
    ...
    final pdfFile = await LabourPdfInvoiceApi.labourgeneratepdf(invoice);

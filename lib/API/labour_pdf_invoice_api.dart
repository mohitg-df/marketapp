...
class LabourPdfInvoiceApi {
  static Future<File> labourgeneratepdf(Invoice invoice) async {
    final pdf = Document();
  ...
  static Widget labourbuildInvoice(Invoice invoice) {
    final headers = [
      'Item',
      // 'Date',
      'Quantity',
  ...
  static Widget buildTotal(Invoice invoice) {
    final netotal = invoice.items.map((e) => e.proprice * e.proquantity)

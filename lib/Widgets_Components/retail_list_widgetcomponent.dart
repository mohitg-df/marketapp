...
class Retailprolistwidgetcomponent extends StatefulWidget {
  @override
  RetailprolistwidgetcomponentState createState() =>
      RetailprolistwidgetcomponentState();
}

class RetailprolistwidgetcomponentState
    extends State<Retailprolistwidgetcomponent> {
                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Addcartproduct()
                              .addcartpro(context, rdukan.rproid, 1);
                        },

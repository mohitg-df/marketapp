...
class Hihomeproductlistwidgetcomponent extends StatefulWidget {
  const Hihomeproductlistwidgetcomponent({Key? key}) : super(key: key);

  @override
  State<Hihomeproductlistwidgetcomponent> createState() =>
      _HihomeproductlistwidgetcomponentState();
}

class _HihomeproductlistwidgetcomponentState
    extends State<Hihomeproductlistwidgetcomponent> {
          ...
          child: Column(
            ...
            children: [
              ...
              CircleAvatar(
                ...
                radius: 40,
                child: Text(
                  '${alldukan.hindiproname![0].toUpperCase()}',
                  style: TextStyle(
                    fontSize: 25,
                    color: Colors.black,
                  ),

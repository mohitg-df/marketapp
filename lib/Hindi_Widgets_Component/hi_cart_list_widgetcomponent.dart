...
class Hicartlistwidgetcomponent extends StatefulWidget {
  @override
  HicartlistwidgetcomponentState createState() => HicartlistwidgetcomponentState();
}

class HicartlistwidgetcomponentState extends State<Hicartlistwidgetcomponent> {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                setState(() {
                  Checkoutapi.checkoutpro(context,query);
                });
              },
